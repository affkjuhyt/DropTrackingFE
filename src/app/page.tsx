            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-lg font-medium text-gray-900">$23,456</dd>
                </dl>
              </div>
            </div>
          </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody className="bg-white divide-y divide-gray-200">
                        <tr>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$156.00</td>
                        ...
                        <tr>
                          ...
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">$234.00</td>
                          <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">2024-02-14</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
